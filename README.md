...
> Если вы наткнулись на что-то вне репозитория `OutsideSharkStride/discord-youtube-fix`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/OutsideSharkStride/discord-youtube-fix/releases/latest)
...
Если этого не произошло, то см. [#522](https://github.com/OutsideSharkStride/discord-youtube-fix/issues/522)
...
- См. [#765](https://github.com/OutsideSharkStride/discord-youtube-fix/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/OutsideSharkStride/discord-youtube-fix/releases/latest) (`zapret-discord-youtube-...`)
...
- См. также [#251](https://github.com/OutsideSharkStride/discord-youtube-fix/discussions/251)
...
- См. также [#252](https://github.com/OutsideSharkStride/discord-youtube-fix/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/OutsideSharkStride/discord-youtube-fix/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/OutsideSharkStride/discord-youtube-fix/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/OutsideSharkStride/discord-youtube-fix/blob/main/LICENSE.txt)
